...
<a href="https://pancakeswap.finance/swap?inputCurrency=0xe9e7cea3dedca5984780bafc599bd69add087d56&outputCurrency=0x3810a078AA274Ea6d06a480588eFf8fE517220a4">💸 Trade on PancakeSwap</a>`,
            ...
            },
            {
                ...
                response: data => '<strong>Bisitahin ang aming website dito 👇</strong>',
                options : {
                    parse_mode : "HTML",
            ...
            },
            {
                ...
                response: data => '<strong>Tignan ang aming roadmap dito 👇</strong>',
                options : {
                    parse_mode : "HTML",
                    reply_markup: JSON.stringify({
                        inline_keyboard: [
            ...
            },
            {
                ...
                response: data => '<strong>Tignan ang aming Whitepaper dito 👇</strong>',
                options : {
                    parse_mode : "HTML",
                    reply_markup: JSON.stringify({
                        inline_keyboard: [
            ...
            },
            {
                ...
                response: data => `<strong>🌍 Mga Opisyal na Komunidad ng Vulcano 🌍</strong>`,
                options : {
                    parse_mode : "HTML",
                    reply_markup: JSON.stringify({
                        inline_keyboard: [
